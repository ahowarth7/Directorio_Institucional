...
class MyPDF extends fpdf_table{
	...
	*----------------------------------------------------------------------------------------------------------*/
	...
	public function drawPDF (){
		...
		$this->Ln(4);
		$this->SetWidths(array(10,15,225),array('C','L'),6,1);
	    $this->Row(array('','CLAVE', 'NOMBRE DEL GRUPO'),array(1,1,1));
		...
		if(is_array($rgrupos)){
		   ...
		   foreach($rgrupos as $key => $rgrupo){
			   ...
			   $this->SetWidths(array(10,15,225),array('C','R','L'),4,1);
			   $this->Row(array($cnt++, $rgrupo['clave'].' ', $rgrupo['descrip']),array(0,0,0));
		   }	
		}	
