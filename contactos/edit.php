<?PHP    
      ...
      $opercacion = $_GET['operacion'];
	  $pid        = $_GET['id'];
	  
	  //verificamos que exista el pid
	  
	  //buscamos los datos del contacto
	  $rperson =  $contact->getInfo($pid);	  
...
<head>
    ...
    <!-- Autosuggest module -->
	<link rel="stylesheet" href="../js/autosuggest/autosuggest_inquisitor.css" type="text/css" media="screen">	
    ...
    <script> 
	    var json_data = <? echo json(utf8_encode_array($rperson),'encode'); ?>;  
	    //try { var json_data = eval("(" + string + ')');    }catch(e){ alert( e.message + '\nError JSON: '+ string ); }
...
String.prototype.removeAccents = function ()
{
	...
	return this.replace(/[¿¡¬√ƒ≈∆»… ÀÃÕŒ“”‘÷Ÿ⁄€‹—]/gi, function(m){
...
<body>
  <div align="center">
    <div id="title-edit" style=" margin:10px;font-weight:bold"> Modificar contacto </div>
  </div>
  <script> $("#title-edit").html("Modificando "+json_data.pers_nombre+' '+json_data.pers_apat+' '+json_data.pers_amat)</script>
  ...
  <div id="tabs" class="s-tabs" style="display:block">
					 ...
					 <td class="data">
                       <div>
                         <div>
					          ...
					          <label for="pers_invi_dm">DÌa internacional de la Mujer (8 de marzo) </label>
					     </div>
                         <div>
                              <input type="checkbox" id="pers_invi_avf" name="pers_invi_avf" value="S">
					          <label for="pers_invi_avf">Aniversario del voto femenino en MÈxico (17 de octubre) </label>
					     </div>
                         <div>
                              <input type="checkbox" id="pers_invi_dievcm" name="pers_invi_dievcm" value="S">
					          <label for="pers_invi_dievcm">DÌa internacional para la eliminaciÛn de la violencia contra la Mujer (25 de Noviembre) </label>
					     </div>
                          <div>
				       ...
				       <td class="data">
                          <div style="width:100%">
						    <div style="width:100px; float:left"> 
						       <input type="text" maxlength="200" value="" allowblank="false" style="width: 90px;" id="pers_dep_tel" class="x-form-field" name="pers_dep_tel"  tab="tabs3" />
						    </div>
