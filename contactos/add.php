					 ...
					 <td class="data">
                       <div>
                         <div>
					          ...
					          <label for="pers_invi_dm">Día internacional de la Mujer (8 de marzo) </label>
					     </div>
                         <div>
                              <input type="checkbox" id="pers_invi_avf" name="pers_invi_avf" value="S">
					          <label for="pers_invi_avf">Aniversario del voto femenino en México (17 de octubre) </label>
					     </div>
                         <div>
                              <input type="checkbox" id="pers_invi_dievcm" name="pers_invi_dievcm" value="S">
					          <label for="pers_invi_dievcm">Día internacional para la eliminación de la violencia contra la Mujer (25 de Noviembre) </label>
					     </div>
                          <div>
