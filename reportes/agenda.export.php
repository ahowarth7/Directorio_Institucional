	...
	public function drawPDF (){
		...
		if(is_array($result)){
		   ...
		   foreach($result as $key => $rperson){						  
				   ...
				   $h   = 4;
				   $lmargen = 6;
				   $this->Cell($lmargen, $h, $cnt++, $b=0, $ln=0, $a= 'R', $f = false, $link = '');
							
				   $this->SetFont('Times','B',8.5);
				   $this->Cell(0,$h, $rperson['pers_nnombre'], $b=0, $ln=1,$a= 'L', $f = false, $link = '');
				   ...
				   $this->Cell($lmargen, $h,'');
				   $this->MultiCell(0,$h, $rperson['pers_ngrupo'], $b=0, $a= 'L', $f = false);
